...
import { getProfile, putProfile, putTutor, getLectureList, updateLectureList, selectSearched } from 'store/actions'
...
const mapDispatchToProps = {
  getProfile, putProfile, putTutor, getLectureList, updateLectureList, selectSearched
}
